...
class TestStoragePool(cloudstackTestCase):
    ...
    def setUpCloudStack(cls):
        ...
        for z in zones:
            cls.debug(pprint.pformat("############################ %s" % cls.getClsConfig().mgtSvr[0].zone))
        ...
        cls.debug(pprint.pformat("############################ %s" % cls.zone))
    ...
    def cleanUpCloudStack(cls):
        try:
            ...
            StoragePool.delete(cls.primary_storage, cls.apiclient)
            StoragePool.delete(cls.primary_storage2, cls.apiclient)
            ServiceOffering.delete(cls.service_offering, cls.apiclient)
            ServiceOffering.delete(cls.service_offering2, cls.apiclient)
            cls.spapi.volumeTemplateDelete(templateName=cls.storpool_primary_storage["name"],)
            cls.spapi.volumeTemplateDelete(templateName=cls.storpool_primary_storage2["name"],)
